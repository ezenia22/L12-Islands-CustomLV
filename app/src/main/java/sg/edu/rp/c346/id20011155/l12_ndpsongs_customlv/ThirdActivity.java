...
public class ThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(ThirdActivity.this, "Invalid Square Kilometer", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() { //change
            @Override
            public void onClick(View v) {
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {  //change
            @Override
            public void onClick(View v) {
                AlertDialog.Builder myBuilder = new AlertDialog.Builder(ThirdActivity.this);
                myBuilder.setTitle("Danger");
